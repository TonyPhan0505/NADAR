...
login_button = Button(lock_frame, text = "Log In", width = 8, height = 2, highlightbackground = "black", bg = "black", fg = "white", command = press_login)
login_button.place(x = 560, y = 345)
signup_button = Button(lock_frame, text = "Sign Up", width = 8, height = 2, highlightbackground = "black", bg = "black", fg = "white",command = press_signup)
